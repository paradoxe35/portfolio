      ...
      {!image && (
        <>
          <div className="absolute inset-0 opacity-5 dark:opacity-10">
            <div className={cn(
              "absolute inset-0",
              "bg-[radial-gradient(circle_at_25%_25%,_theme(colors.primary.DEFAULT)_0%,_transparent_50%),_radial-gradient(circle_at_75%_75%,_theme(colors.purple.500)_0%,_transparent_50%)]"
            )} />
          </div>
          <div className={cn(
          ...
          <div className={cn(
            "absolute -bottom-24 -left-24 w-96 h-96",
            "bg-purple-500/5 dark:bg-purple-400/10",
            "rounded-full blur-3xl"
          )} />
        </>
      )}
