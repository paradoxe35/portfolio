          ...
          >
            <div className="relative z-10">
              <div className="w-12 h-12 mb-4 rounded-xl bg-white/20 dark:bg-white/10 flex items-center justify-center group-hover:bg-white/30 dark:group-hover:bg-white/20 transition-all duration-300">
                <svg
                  className="w-6 h-6 fill-neutral-8 dark:fill-neutral-2 transition-colors"
              ...
              <strong className="block text-xl font-bold text-neutral-8 dark:text-neutral-2 mb-1 transition-colors">
                Github
              </strong>
              <span className="text-sm font-normal text-neutral-6 dark:text-neutral-4">
                @paradoxe35
              </span>
            </div>
          </Link>
