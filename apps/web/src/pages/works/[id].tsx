        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-2xl p-8">
            <div className="prose prose-lg max-w-none dark:prose-invert 
              ...
              prose-code:text-primary dark:prose-code:text-primary-light prose-code:bg-white/20 dark:prose-code:bg-white/10 prose-code:px-2 prose-code:py-1 prose-code:rounded-md
              prose-pre:bg-white/10 dark:prose-pre:bg-white/5 prose-pre:border prose-pre:border-white/20 dark:prose-pre:border-white/10 prose-pre:rounded-xl
