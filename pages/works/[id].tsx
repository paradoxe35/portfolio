        ...
        <Container>
            <div className={style.project}>
                <div className={`${style.columns}`}>
                    <h2 className={style.big} style={{ marginBottom: 0 }}>{project.technology}</h2>

                    {project.link && (
                        <a href={project.link} className={`${homeStyle.project__action} ${style.btn}`} target="_blank">
                            Check it out
                            <svg className={homeStyle.icon__action} xmlns="http://www.w3.org/2000/svg" fill="none" id="arrow" viewBox="0 0 14 14">
...
export default function Work({ project }: { project: SerializedProject }) {
    ...
    return <Application>
        ...
        <main>
            <Header title={project.title} image={image} subtitle={project.description} />
